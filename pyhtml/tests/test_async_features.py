...
from pyhtml.compiler.ast_nodes import ParsedPyHTML, TemplateNode, EventAttribute, BindAttribute
...
"""
        ...
        click_attr = EventAttribute(
            line=1, column=1, name='@click', value='my_async_task()',
            event_type='click', handler_name='my_async_task()'
        )
    ...
    def test_busy_binding(self):
        ...
        click_attr = EventAttribute(
            line=1, column=1, name='@click', value='do_work',
            event_type='click', handler_name='do_work'
        )
        bind_attr = BindAttribute(
            line=1, column=1, name='$bind:busy', value='is_busy',
            variable='is_busy', binding_type='busy'
        )
        
        button = TemplateNode(
            line=1, column=1, tag='button',
            special_attributes=[click_attr, bind_attr]
        )
    ...
    def test_busy_binding_with_async_call(self):
        ...
        click_attr = EventAttribute(
            line=1, column=1, name='@click', value='my_async()',
            event_type='click', handler_name='my_async()'
        )
        bind_attr = BindAttribute(
            line=1, column=1, name='$bind:busy', value='loading',
            variable='loading', binding_type='busy'
        )
