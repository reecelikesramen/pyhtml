...
from pyhtml.runtime.validation import FormValidator, FieldRules
...
class TestServerValidation(unittest.TestCase):
    ...
    def test_type_email(self):
        ...
        self.assertIsNotNone(self.validator.validate_field("email", "test@com", rules)) # naive regex?
    ...
    def test_dynamic_validation(self):
        ...
        self.assertIsNotNone(self.validator.validate_field("val", "20", rules, state_getter=get_state))
        ...
        self.assertIsNotNone(self.validator.validate_field("val", "", rules, state_getter=get_state))
