...
class TestStrictRequirements(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_404_pyhtml_not_error_page(self):
        ...
        # We want to assert that it DOES NOT call match("/404") or even if it does, it shouldn't use it?
    ...
    async def test_nested_error_ignored(self):
        ...
        self.assertNotIn(str(nested_error_path), loaded_paths, "Nested __error__.pyhtml should NOT be loaded")
