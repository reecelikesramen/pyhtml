...
var PyHTML = (() => {
  ...
  // src/pyhtml.dev.ts
  var pyhtml_dev_exports = {};
  __export(pyhtml_dev_exports, {
    DOMUpdater: () => DOMUpdater,
    ErrorTraceHandler: () => ErrorTraceHandler,
    HTTPTransport: () => HTTPTransport,
    PyHTMLApp: () => PyHTMLApp,
    PyHTMLDevApp: () => PyHTMLDevApp,
  ...
  // src/dev/status-overlay.ts
  var StatusOverlay = class {
    constructor() {
      this.element = null;
      this.create();
    }
  ...
  // src/dev/error-trace.ts
  var ErrorTraceHandler = class {
    constructor() {
      this.loadedSources = /* @__PURE__ */ new Set();
    }
    /**
     * Get a virtual URL for a filename that Chrome will display in stack traces.
     */
    getVirtualUrl(filename) {
     ...
     */
    async handle(errorMessage, trace) {
      const filesToLoad = /* @__PURE__ */ new Set();
...
//# sourceURL=${virtualUrl}`;
  ...
  // src/dev/dev-app.ts
  var PyHTMLDevApp = class extends PyHTMLApp {
    constructor(config = {}) {
      super(config);
      this.overlay = null;
  ...
  // src/pyhtml.dev.ts
  var app = new PyHTMLDevApp();
  if (document.readyState === "loading") {
    document.addEventListener("DOMContentLoaded", () => app.init());
  } else {
    app.init();
  }
  return __toCommonJS(pyhtml_dev_exports);
})();
//# sourceMappingURL=pyhtml.dev.min.js.map
